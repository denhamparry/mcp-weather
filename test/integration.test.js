...
describe('Integration Tests', () => {
  ...
  describe('Weather Alert Workflow', () => {
    test('should handle complete alert workflow', async () => {
      ...
      const alertsData = await makeOpenWeatherRequest('http://test-alerts.com', 'test-key');
  ...
  describe('Weather Forecast Workflow', () => {
    test('should handle complete forecast workflow', async () => {
      ...
      const forecastData = await makeOpenWeatherRequest('http://test-forecast.com', 'test-key');
      ...
      assert(formattedForecasts[0].includes('Wind: 3.2 m/s 240° (gusts: 5.1 m/s)'));
  ...
  describe('API Error Handling', () => {
    test('should handle 401 Unauthorized (invalid API key)', async () => {
      ...
      const result = await makeOpenWeatherRequest('http://test.com', 'invalid-key');
    ...
    test('should handle 429 Too Many Requests (rate limiting)', async () => {
      ...
      const result = await makeOpenWeatherRequest('http://test.com', 'test-key');
    ...
    test('should handle network timeout', async () => {
      global.fetch = mock.fn(() => Promise.reject(new Error('Request timeout')));
  ...
  describe('Real-world Data Scenarios', () => {
    ...
    test('should handle extreme weather conditions', () => {
      const extremeAlert = {
        ...
        description: 'Extremely dangerous weather conditions. Do not travel unless absolutely necessary.',
